export const formations = [
    {
      ...
      date: "2023 - Présent",
      description: "Formation spécialisée en intelligence artificielle, orientée vers l'apprentissage automatique, la vision par ordinateur, et le traitement du langage naturel.",
    ...
    },
    {
      ...
      date: "2020 - 2023",
      description: "Formation polyvalente couvrant le développement logiciel, les bases de données, les réseaux, et la gestion de projets.",
  ...
  export const experience = [
    {
      ...
      description: "Développement d'une application web de gestion de stock en équipe.",
